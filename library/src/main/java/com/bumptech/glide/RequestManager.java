...
/**
 * 用于管理和启动glide请求的类。可以使用活动、片段和连接
 * <p>
 * 智能停止、启动和重新启动请求的生命周期事件。检索方式
 * <p>
 * 实例化新对象，或利用内置活动和片段生命周期
 * <p>
 * 处理时，在片段或活动中使用static glide.load方法。
 *
...
public class RequestManager implements LifecycleListener,
     ...
     * 根据不停类型构造不同的RequestBuilder 对象
     * 例如Drawable类型  resourceClass就是Drawable.class
     */
    @NonNull
    @CheckResult
